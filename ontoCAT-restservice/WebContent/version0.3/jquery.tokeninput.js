...
$.TokenList = function (input, settings) {
    ...
    function insert_token(accession, value) {
...
//        var this_token = insert_token(li_data.id, li_data.name);
    ...
    function run_search(query) {
	    ...
	    var params = {};                       //added http://github.com/loopj/jQuery-Tokenizing-Autocomplete-Plugin/issues#issue/1
	    params[settings.queryParam] = query;   //added http://github.com/loopj/jQuery-Tokenizing-Autocomplete-Plugin/issues#issue/1      
