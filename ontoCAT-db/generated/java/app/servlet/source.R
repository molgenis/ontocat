...
# File:        ontocatdb/R/generated/java/app/servlet/source.R
# Copyright:   GBIC 2000-2,010, all rights reserved
# Date:        February 24, 2010
#
# generator:   org.molgenis.generators.R.RApi 3.3.2-testing
#
...
#entities
source(paste(molgenispath,"ontocatdb/R/Investigation.R", sep=""))
source(paste(molgenispath,"ontocatdb/R/OntologySource.R", sep=""))
source(paste(molgenispath,"ontocatdb/R/OntologyTerm.R", sep=""))
source(paste(molgenispath,"ontocatdb/R/Sample.R", sep=""))
