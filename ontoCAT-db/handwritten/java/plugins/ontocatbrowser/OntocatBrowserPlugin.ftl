...
<table style="border-collapse: separate;">
	...
	<tr>
		...
		<td valign="top" style="padding: ${padding}; border-width: ${borderWidthSpacing}; border-spacing: ${borderWidthSpacing}; border-style: ${borderStyle}; border-color: ${controlBorderColor}; background-color: ${headerBgcolor};">
			...
			<#if model.getExploreMode()?exists>
				...
				<#else>
					<img src="res/img/info.png" width="${picSize}" height="${picSize}"/>
					<i>Source: <b>DATABASE</b>, 'name' is modifiable.</i><br />
	...
	<tr>
		...
		<td style="vertical-align: top; padding: ${padding}; border-width: ${borderWidthSpacing}; border-spacing: ${borderWidthSpacing}; border-style: solid; border-color: #008000;">
			<b>Ontology Browser Plugin</b><br>
			Based on <a href="http://ontocat.sourceforge.net/">Ontology Common API Tasks</a>.<br>
			Queries the <a href="http://www.ebi.ac.uk/ontology-lookup/">EBI ontology database/</a>.
		</td>
	</tr>
